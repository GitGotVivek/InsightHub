...
//     return (
//         <header className={`fixed top-0 left-0 right-0 w-full transition-all duration-300 z-50 ${isScrolled ? 'bg-black/70 backdrop-blur-md' : 'bg-black/25 backdrop-blur-sm'}`}>
//             <nav className='p-2 max-w-7xl mx-auto flex justify-between items-center'>
//                 <a href="/" className='text-xl font-bold text-white'>
//                     {/* Vivek<span className='text-orange-500'>Blog</span> */}
//                     {/* <img src={logo} alt="" /> */}
//                 </a>

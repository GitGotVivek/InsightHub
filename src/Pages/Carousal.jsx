...
import sliderVideo from "../Images/blogBanner3.mp4"
import sliderVideo3 from "../Images/slider3.mp4"
import backImage from "../Images/blogBack.jpg"
            ...
            <div id="carouselExampleCaptions" className="carousel slide relative" data-bs-ride="carousel">
                ...
                <div className="carousel-inner relative w-full overflow-hidden">
                    <div className="carousel-item active relative float-left w-full">
                        {/* <video className="block w-full h-[580px] object-cover" autoPlay loop muted>
                            <source src={sliderVideo} type="video/mp4" />
                        </video> */}
                        <img src={slide2} className="block w-full h-[580px] object-fit" alt="..." />
                    ...
                    <div className="carousel-item relative float-left w-full">
                        <img src={img3} className="block w-full h-[580px] object-fit" alt="..." />
                        <div className="carousel-caption block absolute text-center bg-black/50 backdrop-blur-sm p-4">
                    ...
                    <div className="carousel-item relative float-left w-full bg-cover bg-center"
                    //  style={{ backgroundImage: `url(${backImage})`, height: '100%' }}
                     >
                        {/* <div className="flex flex-wrap justify-center gap-4 p-4">
                            <div className="w-full sm:w-1/2 lg:w-1/4 p-2">
                                <img src={img3} className="w-full h-auto object-cover rounded-lg" alt="Additional 1" />
                            </div>
                            <video className="w-full sm:w-1/2 lg:w-1/4 p-2" autoPlay loop muted>
                                <source src={sliderVideo3} type="video/mp4" />
                            </video>
                            <div className="w-full sm:w-1/2 lg:w-1/4 p-2">
                                <img src={img1} className="w-full h-auto object-cover rounded-lg" alt="Additional 2" />
                            </div>
                            <div className="w-full sm:w-1/2 lg:w-1/4 p-2">
                                <img src={img3} className="w-full h-auto object-cover rounded-lg" alt="Additional 3" />
                            </div>
                            <video className="w-full sm:w-1/2 lg:w-1/4 p-2" autoPlay loop muted>
                                <source src={sliderVideo3} type="video/mp4" />
                            </video>
